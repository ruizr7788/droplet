...
var _mainInfoView = require("./views/mainInfoView");
var _mainInfoViewDefault = parcelHelpers.interopDefault(_mainInfoView);
var _dayTemperaturesView = require("./views/dayTemperaturesView");
var _dayTemperaturesViewDefault = parcelHelpers.interopDefault(_dayTemperaturesView);
var _tomorrowView = require("./views/tomorrowView");
var _tomorrowViewDefault = parcelHelpers.interopDefault(_tomorrowView);
var _uvView = require("./views/uvView");
var _uvViewDefault = parcelHelpers.interopDefault(_uvView);
var _predictionView = require("./views/predictionView");
var _predictionViewDefault = parcelHelpers.interopDefault(_predictionView);
var _view = require("./views/view");
var _viewDefault = parcelHelpers.interopDefault(_view);
const searchController = async function(query) {
    try {
        _model.resetState();
        await _model.setState(query);
        _searchViewDefault.default.renderInfo(_model.state);
        _mainInfoViewDefault.default.renderInfo(_model.state);
        _dayTemperaturesViewDefault.default.renderInfo(_model.state);
        _tomorrowViewDefault.default.renderInfo(_model.state);
        _uvViewDefault.default.renderInfo(_model.state);
        _predictionViewDefault.default.renderInfo(_model.state);
    } catch (err) {
        _searchViewDefault.default._renderError(err.message);
    }
};
const init = function() {
    _searchViewDefault.default.addHandlerQuery(searchController);
};
init();

},{"core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","./model":"Y4A21","./views/searchView":"9OQAM","./views/mainInfoView":"5HQHy","./views/dayTemperaturesView":"5knhe","./views/tomorrowView":"9lCAW","./views/uvView":"e8Pj5","./views/predictionView":"88ftR","./views/view":"bWlJ9","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"49tUX":[function(require,module,exports) {
...
const setState = async function(query) {
    try {
        const data = await Promise.race([
            _helpers.getJSON(` https://api.weatherapi.com/v1/forecast.json?key=29e0186ae9ac4bc18c444525220402&q=${query}&days=7&aqi=yes`, query),
            timeout5(), 
        ]);
        //-----STORING LOCATION-----
        ...
        state.currentWeather.morningTemp = data.forecast.forecastday[0].hour[6].temp_f;
        state.currentWeather.afternoonTemp = data.forecast.forecastday[0].hour[12].temp_f;
        state.currentWeather.eveningTemp = data.forecast.forecastday[0].hour[18].temp_f;
        ...
        state.tomorrowWeather.description = data.forecast.forecastday[1].day.condition.text;
...
const getJSON = function(url, query, errorMsg = "No results") {
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5HQHy":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class MainInfo {
    ...
    `;
        ...
        <span id="wind__speed" class="main--white">
            ...
            <span id="wind__direction" class="secondary--white">
                ${data.currentWeather.windSpeed !== 0 ? data.currentWeather.windDirection : ""}
            </span>
        </span>
...
exports.default = new MainInfo();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"5knhe":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = new DayTemperatures();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"9lCAW":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class TomorrowView {
...
exports.default = new TomorrowView();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"e8Pj5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class UvVIEW {
    ...
    renderInfo(data) {
        document.querySelector(".uv--index-box").style.background = data.currentWeather.uvColor;
...
exports.default = new UvVIEW();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"88ftR":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
class PredictionView {
    ...
    #dayAfterNextDescription = document.getElementById("day__after--next-description");
...
exports.default = new PredictionView();

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["ddCAb","aenu9"], "aenu9", "parcelRequire15b1")
