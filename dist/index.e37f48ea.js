...
var _dayTemperaturesView = require("./dayTemperaturesView");
...
},{"core-js/modules/web.immediate.js":"49tUX","regenerator-runtime/runtime":"dXNgZ","./views/searchView":"9OQAM","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./model":"Y4A21","./views/mainInfoView":"5HQHy","./dayTemperaturesView":"8bzZV","./views/tomorrowView":"9lCAW","./views/uvView":"e8Pj5","./views/predictionView":"88ftR"}],"49tUX":[function(require,module,exports) {
...
const setState = async function(query) {
    const data = await _helpers.getJSON(` http://api.weatherapi.com/v1/forecast.json?key=29e0186ae9ac4bc18c444525220402&q=${query}&days=7&aqi=yes`);
    //-----STORING LOCATION-----
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"8bzZV":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
